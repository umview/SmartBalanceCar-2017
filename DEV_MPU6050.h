...
//I2C0 - PTB2、PTB0、PTD8
//I2C1 - PTC10、PTE1
#define MPU6050_SCLPIN  (PTB2)

//连接MPU6050用到的SDA引脚
//I2C0 - PTB3、PTB1、PTD9
//I2C1 - PTC11、PTE0
#define MPU6050_SDAPIN  (PTB3)
/********用户可修改值 结束***********/
...
#define GetGyroZ() MPU6050GetResult(GYRO_YOUT_H)
#define GetAccelZ() -MPU6050GetResult(ACCEL_XOUT_H)
#define GetGyroY() MPU6050GetResult(GYRO_ZOUT_H)


//函数声明
void  MPU6050_WriteReg(uint8 RegisterAddress, uint8 Data);
uint8 MPU6050_ReadReg(uint8 RegisterAddress);
int16 MPU6050GetResult(uint8 Regs_Addr);
void  MPU6050Init();
